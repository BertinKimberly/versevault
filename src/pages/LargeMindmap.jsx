...
export default function LargeMindmap() {
   ...
   return (
      <>
         <Helmet>
            <meta charSet="utf-8" />
            <title>Spiritual Growth Mindmap | VerseVault</title>
            <meta
               name="description"
               content="Explore spiritual growth concepts and practices through an interactive mindmap."
            />
         </Helmet>
               ...
               <h1 className="text-2xl font-bold text-white flex items-center">
                  ...
                  >
                     <path
                        ...
                        strokeWidth={2}
                        d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.172 2.172a2 2 0 010 2.828l-8.486 8.486a2 2 0 01-2.828 0l-2.172-2.172a2 2 0 010-2.828L7.344 11"
                     />
                  </svg>
            ...
            <div className="flex-1 flex overflow-hidden">
               ...
               <div className="flex-1 relative">
                  ...
                  >
                     ...
                     <Panel
                        position="top-left"
                        className="bg-[#0f1838]/80 backdrop-blur-sm p-3 rounded-lg border border-[#5a77de]/30 text-white"
                     >
                     ...
                     <Panel
                        ...
                        className="bg-[#0f1838]/80 backdrop-blur-sm p-3 rounded-lg border border-[#5a77de]/30 text-white max-w-xs"
                     >
                     ...
                     <Panel
                        position="top-right"
                        className="bg-[#0f1838]/80 backdrop-blur-sm p-2 rounded-lg border border-[#5a77de]/30 text-white"
                     >
                        ...
                        <div className="mt-6 flex gap-2">
                           <button
                              ...
                              onClick={() => {
                                 ...
                                 const uniqueConnectedNodes = [
                                    ...new Set(connectedNodes),
                                 ];

                                 const relatedNodes = nodes.filter(
                                    (node) =>
                                       uniqueConnectedNodes.includes(node.id) ||
